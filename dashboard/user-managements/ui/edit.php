...
<body class="bg-gray-100">
  ...
  <div class="ml-64 pt-20 p-8">
    ...
    <div class="bg-white border rounded-xl shadow p-10 max-w-full">
      ...
      <form action="dashboard/user-managements/update/<?= $id ?>" method="POST" class="space-y-6">
        ...
        <!-- Password (Optional) -->
        <div>
          <label class="block mb-2 text-gray-700 font-medium">Password Baru (opsional)</label>
        ...
        <div>
          ...
          <select name="role" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
